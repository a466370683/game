# Generated by Django 2.2.6 on 2019-11-03 02:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hero_id', models.IntegerField()),
                ('map', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.GameMap')),
                ('myhero', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.Hero')),
            ],
        ),
        migrations.CreateModel(
            name='Monster',
